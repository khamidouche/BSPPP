...
#ifndef  TEST_GMV_LIGNE_HPP__INCLUDED__
#define  TEST_GMV_LIGNE_HPP__INCLUDED__


#include "bsp_GMV_ligne.hpp"
#include "data.hpp"
...
template<class T>
void test_gmv_ligne(int argc, char ** argv){
...
n=(*recv)(0);
  ...
  for(int i=0;i<n/p;i++)
    ...
    bsp_GMV_ligne<double>(n,p,U,A,V,ParV,Tcomp,Tcomm);
///////////////////////////////////////*
