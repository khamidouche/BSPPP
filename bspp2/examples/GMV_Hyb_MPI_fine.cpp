...
#include "bsp_GMV_Hyb_MPI_fine.hpp"
#include "data.hpp"
...
template<class T>
void test_gmv_hyb_mpi(int argc, char ** argv){
...
n=(*recv)(0)[2];
  ...
  for(int i=0;i<n/N;i++)
    ...
    bsp_GMV_mpi_fine<double>(argc,argv,M,N,s,t,n,p,U,A,V,ParV,Tcomp,Tcomm);
...
test_gmv_hyb_mpi<double>(argc,argv);
return 0;
}
