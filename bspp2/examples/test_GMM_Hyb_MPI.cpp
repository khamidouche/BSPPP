...
template<class T>
void test_gmm_hyb_mpi(int argc, char ** argv){
...
//      }
   ...
   // printf("eeeeeeeeeee\n");
    ...
    bsp_GMM_Hyb_MPI<double>(argc,argv,m1,n1,s,t,nm,b,nlr,nlc,ParA,ParB,A,B,C,Tcomp,Tcomm);
    ...
    time1=bsp::time();
     ...
     synchronize();
        ...
        for (int j=0; j<2; j++){
                ...
                std::cout<<"rank = "<<pid<<" C[ "<<nlr-i-1<<" ]["<<nlc-j-1<<"]= "<<C(nlr-i-1,nlc-j-1)<<std::endl;
        }
         }
...
//{
//
//  test_gmm_hyb_mpi<double>(argc,argv);
//  return 0;
//}
