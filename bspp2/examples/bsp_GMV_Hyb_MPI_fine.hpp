...
#ifndef  BSP_GMV_HYB_MPI_FINE_HPP__INCLUDED__
#define  BSP_GMV_HYB_MPI_FINE_HPP__INCLUDED__


#include "GMV_Hyb_OMP_fine.hpp"
#include "data.hpp"
...
template<class T>
void inline bsp_GMV_mpi_fine(int argc, char** argv,int const& M,int const &N,int const &s, int const& t,int const &n,int const& P,
...
//      }
        ...
        bsp_GMV_OMP_fine_1( argc,argv,M,N,n,U, A, (*ParV), Tcomp, Tcomm);
...
//         (*ParV)[k]+= (*recv1)(d)[k];
   bsp_GMV_OMP_fine_2( argc, argv,N,n,(*ParV), (*recv1)(d));
