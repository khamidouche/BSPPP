...
static void init_state(conf* current, path* current_path, path* first_path, int path_len)
{
  ...
  current_path->s_2_6 = current->s_2_6;
  current_path->s_3_1 = current->s_3_1;
  current_path->s_3_6 = current->s_3_6;
  current_path->s_4_1 = current->s_4_1;
  current_path->s_4_6 = current->s_4_6;
  current_path->s_5_1 = current->s_5_1;
  current_path->s_5_6 = current->s_5_6;
  current_path->s_6_1 = current->s_6_1;
  current_path->s_6_2 = current->s_6_2;
  current_path->s_6_3 = current->s_6_3;
  current_path->s_6_4 = current->s_6_4;
  current_path->s_6_5 = current->s_6_5;
  current_path->s_6_6 = current->s_6_6;
}
...
{
  return ((__p->s_1_1==3)||(__p->s_1_2==3)||(__p->s_1_3==3)||(__p->s_1_4==3)||(__p->s_1_5==3)||(__p->s_1_6==3)||(__p->s_2_1==3)||(__p->s_2_6==3)||(__p->s_3_1==3)||(__p->s_3_6==3)||(__p->s_4_1==3)||(__p->s_4_6==3)||(__p->s_5_1==3)||(__p->s_5_6==3)||(__p->s_6_1==3)||(__p->s_6_2==3)||(__p->s_6_3==3)||(__p->s_6_4==3)||(__p->s_6_5==3)||(__p->s_6_6==3)||(0>1));
}
