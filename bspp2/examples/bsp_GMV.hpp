...
#ifndef  BSP_GMV_HPP__INCLUDED__
#define  BSP_GMV_HPP__INCLUDED__
...
template<class T>
void inline bsp_GMV(int const& M,int const &N,int const &s, int const& t,int const &n,int const& P,
